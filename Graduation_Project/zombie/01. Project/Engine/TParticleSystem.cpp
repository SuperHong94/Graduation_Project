...
CTParticleSystem::CTParticleSystem()
	...
	, m_vEndColor(Vec4(1.0f, 1.0f, 1.0f, 0.2f))
{
	...
	// Material
	m_pMtrl = CResMgr::GetInst()->FindRes<CMaterial>(L"TParticleMtrl");
...
void CTParticleSystem::finalupdate()
{
	// 추가될 파티클 개수 계산
	m_fAccTime += DT;
...
void CTParticleSystem::SaveToScene(FILE* _pFile)
{
}

void CTParticleSystem::LoadFromScene(FILE* _pFile)
{
}
