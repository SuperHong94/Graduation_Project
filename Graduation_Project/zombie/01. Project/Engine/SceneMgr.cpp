...
void CSceneMgr::CreateTargetUI()
{
	...
	if (SceneState == SCENE_STATE::GAME_SCENE)
	{
		for (UINT i = 0; i < NumgameSceneUI; ++i)
		{
			...
			pObject->FrustumCheck(false);	// ¿˝µŒ√º ƒ√∏µ ªÁøÎ«œ¡ˆ æ ¿Ω
...
>>>>>>> parent of 0651e18 (ÌÅ¥ÎùºÏù¥Ïñ∏Ìä∏ Î∞∞Ïó¥Ï∂îÍ∞ÄÌñàÎçîÎãà Ïò§Î•òÍ∞ÄÎÇ®)
		...
		pCSMtrl->Dispatch(1, 1024, 1); // --> ƒƒ«ª∆Æ Ω¶¿Ã¥ı ºˆ«‡	
		...
		// =================================
		// CollisionMgr √Êµπ ±◊∑Ï(Layer) ¡ˆ¡§
		// =================================
		// Player Layer øÕ Monster Layer ¥¬ √Êµπ ∞ÀªÁ ¡¯«‡
