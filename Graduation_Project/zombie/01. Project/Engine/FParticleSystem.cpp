...
CFParticleSystem::CFParticleSystem()
	...
	, m_vEndColor(Vec4(1.0f, 1.0f, 1.0f, 0.2f))
{
	...
	// Material
	m_pMtrl = CResMgr::GetInst()->FindRes<CMaterial>(L"FParticleMtrl");
...
void CFParticleSystem::finalupdate()
{
	// 추가될 파티클 개수 계산
	m_fAccTime += DT;
...
void CFParticleSystem::SaveToScene(FILE* _pFile)
{
}

void CFParticleSystem::LoadFromScene(FILE* _pFile)
{
}
