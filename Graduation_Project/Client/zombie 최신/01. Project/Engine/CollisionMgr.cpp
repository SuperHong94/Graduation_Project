...
bool CCollisionMgr::IsCollision(CCollider2D * _pCollider1, CCollider2D * _pCollider2)
{
	...
	if (COLLIDER2D_TYPE::RECT == _pCollider1->GetColliderType() && COLLIDER2D_TYPE::RRECT == _pCollider2->GetColliderType())
	{
		return CollisionRRect(_pCollider1, _pCollider2);
	}
	else
	{
...
bool CCollisionMgr::CollisionRRect(CCollider2D* _pCollider1, CCollider2D* _pCollider2)
{
	static Vec3 arrLocal[4] = {					// 0 -- 1
		  Vec3(-0.5f, 0.5f, 0.f)				// |	|
